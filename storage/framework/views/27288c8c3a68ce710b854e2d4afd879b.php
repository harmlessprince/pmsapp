...
<?php $component = App\View\Components\FilterCard::resolve(['actionUrl' => route('admin.scan.index'),'canExport' => true,'canDelete' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'name','class' => 'block w-full pl-[20%]','type' => 'text','datepicker' => true,'datepickerAutohide' => true,'datepickerFormat' => 'dd-mm-yyyy','placeholder' => 'Select start date','name' => 'scan_date_from_date','value' => request()->query('scan_date_from_date')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'name','class' => 'block w-full pl-[20%]','type' => 'text','datepicker' => true,'datepicker-autohide' => true,'datepicker-format' => 'dd-mm-yyyy','placeholder' => 'Select start date','name' => 'scan_date_from_date','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->query('scan_date_from_date'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginal9b0da1ce4a7273760fcbfd5667774437 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9b0da1ce4a7273760fcbfd5667774437 = $attributes; } ?>
<?php $component = App\View\Components\Loader::resolve(['loaderId' => 'ajax_loader_tag'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('loader'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Loader::class))->getConstructor()): ?>
                ...
                <table class="table-fixed w-[100%] max-lg:w-[1000px] bg-background_color">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $scans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border border-table border-x-0 text-natural hover:bg-db">
                            ...
                            <td class="text-left text-normal font-normal px-smaller"><?php echo e($scan->tag->name); ?></td>
                            <td class="text-left text-normal font-normal px-smaller"><?php echo e($scan->site->name); ?></td>
                            <td class="text-left text-normal font-normal px-smaller"><?php echo e($scan->company->name); ?></td>
                            <td class="text-left text-normal font-normal p-smaller"><?php echo e($scan->longitude ?? '-'); ?></td>
                            <td class="text-left text-normal font-normal px-smaller"><?php echo e($scan->longitude ?? '-'); ?></td>

                            <td class="text-left text-normal font-normal px-smaller"><?php echo e($scan->proximity); ?></td>
                            <td class="px-small">
                                <div class="flex flex-row justify-end">
                                    <form id="frm-delete-item-<?php echo e($scan->id); ?>"
                                          action="<?php echo e(route('admin.scan.destroy', ['scan' => $scan])); ?>"
                                    ...
                                    <a href=""
                                       onclick='deleteItem(event, <?php echo e("$scan->id"); ?>)'>
                                            <span
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/harmlessprince/webprojects/laravel/pmsapp/resources/views/admin/scan/index.blade.php ENDPATH**/ ?>