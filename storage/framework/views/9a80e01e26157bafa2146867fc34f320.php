        ...
        <section class="pt-basic_padding">
            ...
            <div class="font-big text-big text-natural mb-2 flex flex-row justify-between">
                ...
                <div
                    ...
                    <a href="<?php echo e(route('company.regions.create')); ?>">
...
<?php $component = App\View\Components\FilterCard::resolve(['actionUrl' => route('company.regions.index'),'canSearch' => true,'searchPlaceholder' => 'Search by name'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'site_id','value' => __('Site')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'site_id','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Site'))]); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'site_id','class' => 'block mt-1 w-full','name' => 'site_id']); ?>
                            ...
                            <tr class="text-normal font-normal border border-table border-x-0 border-b-0 text-natural hover:bg-db">
                                ...
                                <td class="px-small text-center">
                                    ...
                                    <div class="flex flex-row justify-between gap-1">
                                        <a href="<?php echo e(route('company.regions.edit', ['region' => $region->id])); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/harmlessprince/webprojects/laravel/pmsapp/resources/views/company/regions/index.blade.php ENDPATH**/ ?>