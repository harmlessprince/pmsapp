...
<?php $component = App\View\Components\FilterCard::resolve(['actionUrl' => route('admin.attendance.index'),'canSearch' => true,'searchPlaceholder' => 'Search by name','canExport' => true,'canDelete' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                ...
                <table class="table-fixed w-[100%] max-lg:w-[1000px] bg-background_color">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border border-table border-x-0 text-natural hover:bg-db">
                            ...
                            <td class="text-normal font-normal px-smaller"><?php echo e($attendance->company->display_name); ?></td>
                            ...
                            <td class="px-small">
                                <div class="flex flex-row justify-end">
                                    <form id="frm-delete-item-<?php echo e($attendance->id); ?>"
                                          action="<?php echo e(route('admin.attendance.destroy', ['attendance' => $attendance])); ?>"
                                    ...
                                    <a href=""
                                       onclick='deleteItem(event, <?php echo e("$attendance->id"); ?>)' title="Delete a personnel attendance">
                                            <span
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/harmlessprince/webprojects/laravel/pmsapp/resources/views/admin/attendance/index.blade.php ENDPATH**/ ?>