<?php $__env->startSection('title', 'PerfTraka Terms and Conditions'); ?>
    ...
    <article class="mx-auto max-w-4xl rounded-[8px] bg-white p-6 shadow-sm md:p-10">
        ...
        <div class="mt-8 space-y-8 leading-7">
            ...
            <section>
                ...
                <p class="mt-3">PerfTraka's collection and processing of personal information is described in our <a href="<?php echo e(route('privacy-policy')); ?>" class="font-semibold text-[#226F65]">Privacy Policy</a>. By using the Service, you acknowledge that information may be collected and processed as described there.</p>
            ...
            <section>
                ...
                <p class="mt-3">For questions about these Terms and Conditions, please contact PerfTraka through the website at <a href="https://perftraka.com" class="font-semibold text-[#226F65]">https://perftraka.com</a>.</p>
            </section>
        </div>
    </article>
</section>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/harmlessprince/webprojects/laravel/pmsapp/resources/views/legal/terms.blade.php ENDPATH**/ ?>