...
<?php $__env->startSection('page', 'Site Management'); ?>
        ...
        <section class="pt-basic_padding">
            <div class="font-big text-big text-natural mb-2 flex flex-row items-center justify-between">
                ...
                <div
                    ...
                    <img src="<?php echo e(asset('assets/images/plus.png')); ?>" class="w-[11px] h-[11px]" alt="plus"/>
                    <a href="<?php echo e(route('company.sites.create')); ?>">
...
<?php $component = App\View\Components\FilterCard::resolve(['actionUrl' => route('company.sites.index'),'hasTable' => false,'canSearch' => true,'searchPlaceholder' => 'Search by site name or email'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                    ...
                    <table class="table-fixed w-[100%] max-lg:w-[1000px]">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="text-normal text-basic font-normal text-natural border border-table border-collapse hover:bg-db">
                                <td class="text-natural px-small py-small"><?php echo e($site->state->country->name); ?></td>
                                <td class="px-small"><?php echo e($site->state->name); ?></td>
                                <td class="px-small">
                                    <?php echo e($site->name); ?>

                                </td>
                                <td class="px-small">
                                    <?php echo e(optional($site->inspector)->email); ?>

                                </td>
                                <td class="px-small">
                                    <?php if($site->photo): ?>
                                        <img src="<?php echo e($site->photo); ?>"
                                             alt="dashboard"
                                             class=" w-[60px] h-[60px]"
                                             data-modal-target="imageViewModalElement"
                                             data-modal-toggle="imageViewModalElement"
                                             onclick='showImageModal("<?php echo e($site->photo); ?>")'
                                        />
                                    <?php else: ?>
                                        No Image
                                    <?php endif; ?>
                                ...
                                <td class="px-small">
                                    <div class="flex flex-row justify-end">
                                        <a href="<?php echo e(route('company.sites.edit', ['site' => $site])); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/harmlessprince/webprojects/laravel/pmsapp/resources/views/company/site/index.blade.php ENDPATH**/ ?>