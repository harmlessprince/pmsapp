...
@section('content')
    ...
    <form class="mt-[2%] w-[100%]" action="{{route('company.users.store')}}" method="POST"
        ...
        <div class="flex flex-row justify-between mb-2 max-lg:flex-col">
            <div class="w-[49%] max-lg:w-full max-lg:mb-2">
                ...
                <x-text-input name="shift_start_time" :value="old('shift_start_time', '00:00')" class="" id="time"
                              type="time"/>
            ...
            <div class="w-[49%] max-lg:w-full">
                ...
                <x-text-input name="shift_end_time" :value="old('shift_end_time', '23:59')" class="" id="time"
                              type="time"/>
            ...
            <div class="flex flex-col">
                ...
                <x-select-input id="site_id" class="block mt-1 w-full" name="site_id">
                    ...
                    @foreach($sites as $site)
                        <option
                            value="{{$site->id}}" {{ old('site_id') == $site->id ? "selected" : '' }}>{{$site->name}}</option>
                    @endforeach
                </x-select-input>
                <x-input-error :messages="$errors->get('site_id')" class="mt-2"/>
            </div>
            <div class="flex flex-col">
                <x-input-label for="night_shift_allowance" :value="__('Night Shift allowance')"/>
                <x-text-input id="night_shift_allowance" class="block mt-1 w-full" type="number" name="night_shift_allowance"
                              :value="old('night_shift_allowance')"
                              required/>
