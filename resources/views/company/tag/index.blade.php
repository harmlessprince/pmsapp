                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-[100%] max-lg:w-[1000px]">
                        ...
                        <tr class="text-left text-small text-natural font-big">
                            ...
                            <th class="px-smaller py-[1%] w-[15%]">Tag Name</th>
                            <th class="px-smaller py-[1%] w-[10%]">Code</th>
                            <th class="px-smaller py-[1%] w-[20%]">Comments</th>
                            <th class="px-smaller py-[1%] w-[12%]">Tag</th>
                            <th class="px-smaller py-[1%] w-[5%]">Action</th>
                        </tr>
                        </thead>
                        <tbody>
                        @forelse($tags as $tag)
                            <tr class="text-normal font-normal text-natural border border-table border-x-0 border-b-0 hover:bg-db">
                                <td class="px-smaller py-small">{{$tag->site->state->country->name ?? 'N/A'}}</td>
                                <td class="px-smaller">
                                    {{$tag->site->name ?? 'N/A'}}
                                </td>
                                <td class="px-smaller">
