<footer
    ...
    <div class="flex-1 max-mobile:w-full">
        ...
        <div class="grid grid-cols-2 gap-x-6 gap-y-2 py-2 font-normal text-size1 max-mobile:grid-cols-1">
            ...
            <a href="{{ route('welcome') }}#getInTouch"><span>Contact us</span></a>
            <a href="{{ route('privacy-policy') }}"><span>Privacy Policy</span></a>
            <a href="{{ route('terms-and-conditions') }}"><span>Terms and Conditions</span></a>
            <a href="{{ route('account-deletion') }}"><span>Account Deletion</span></a>
        </div>
    </div>
