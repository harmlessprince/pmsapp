...
@section('content')
    ...
    <form class="mt-[2%] w-[100%]" action="{{route('admin.companies.store')}}" method="POST">
        @csrf
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div class="flex flex-col">
                ...
                <x-text-input id="maximum_number_of_tags" class="block mt-1 w-full" type="number" name="maximum_number_of_tags" :value="old('maximum_number_of_tags')" required/>
